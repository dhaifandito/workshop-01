              ...
              <DialogHeader>
                ...
                <DialogDescription>
                  <div className="flex justify-center items-center py-5 flex-col text-lg">
                    <p className="my-5">Yes, I'm sure to delete <span className="text-yellow-500 font-bold">{props.eventName}</span></p>
                    <Button variant="destructive" onClick={()=>removingEvent(props.eventName)}>Delete</Button>
                  </div>
                </DialogDescription>
              </DialogHeader>
            </DialogContent>
